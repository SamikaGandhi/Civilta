fetch('blog.json')
  ...
  .then(data => {
    const blog = data[22];
    const blogContainer = document.getElementById('blog-content6');
    const blogHTML = `
      <div class="row">
        <div class="col-sm col-md-12 col-lg-12 ftco-animate">
          <div class="room">
            ...
            <div class="text p-3 text-center">
              ...
              <hr>
              <p class="pt-1"><a href="${blog.link || 'baby.html'}" class="btn-custom">View blog <span class="icon-long-arrow-right"></span></a></p>
            </div>
          </div>
        </div>
      </div>
